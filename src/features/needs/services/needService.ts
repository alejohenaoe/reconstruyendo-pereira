...
const NEED_SELECT =
  'id,user_id,title,description,category_id,municipality_id,neighborhood,status,needs_assessment,resolution_note,is_hidden,created_at,need_categories(label_es),municipalities(name)'
