...
- Scripts (ver `package.json`):
  ...
  - `npm run test:contracts` — contratos e2e/seguridad (`supabase/tests/run_all.sh`). **Requiere el stack local corriendo** (`supabase status`). Ejecuta en orden: rls_security (53), auth (14), publish (30), help (59), moderation (50), notifications (49).
